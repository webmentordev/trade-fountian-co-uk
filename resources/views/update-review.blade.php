            ...
            <form action="{{ route('update.review', $review->id) }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-4 mb-3">
                    ...
                    <div class="w-full">
                        ...
                        <x-text-input id="title" autocomplete="off" name="title" class="block mt-1 w-full" type="text" value="{{ $review->title }}" required />
                        <x-input-error :messages="$errors->get('title')" class="mt-2" />
                    </div>

                    <div class="w-full">
                        <x-input-label for="location" :value="__('Location')" />
                        <x-text-input id="location" autocomplete="off" name="location" value="United Kingdom" class="block mt-1 w-full" value="{{ $review->location }}" type="text" />
                    ...
                    <div class="w-full">
                        ...
                        <x-text-input id="color" autocomplete="off" name="color" class="block mt-1 w-full" type="text" value="{{ $review->color }}" required />
