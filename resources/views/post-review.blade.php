            ...
            <form action="{{ route('post.review') }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-4 mb-3">
                    ...
                    <div class="w-full">
                        ...
                        <x-text-input id="title" autocomplete="off" name="title" class="block mt-1 w-full" type="text" required />
                        <x-input-error :messages="$errors->get('title')" class="mt-2" />
                    </div>

                    <div class="w-full">
                        <x-input-label for="location" :value="__('Location')" />
                        <x-text-input id="location" autocomplete="off" name="location" value="United Kingdom" class="block mt-1 w-full" type="text" />
